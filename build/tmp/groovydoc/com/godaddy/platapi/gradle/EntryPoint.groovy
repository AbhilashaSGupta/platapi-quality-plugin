...
import com.godaddy.platapi.gradle.report.CheckstyleReporter
import com.godaddy.platapi.gradle.report.CpdReporter
import com.godaddy.platapi.gradle.report.HtmlReportGenerator
import com.godaddy.platapi.gradle.report.PmdReporter
import com.godaddy.platapi.gradle.report.Reporter
import com.godaddy.platapi.gradle.report.SpotbugsReporter
import com.godaddy.platapi.gradle.spotbugs.CustomSpotBugsPlugin
import com.godaddy.platapi.gradle.task.InitPlatapiPluginConfigTask
import com.godaddy.platapi.gradle.util.CpdUtils
import com.godaddy.platapi.gradle.util.DurationFormatter
import com.godaddy.platapi.gradle.util.SpotbugUtils
import com.godaddy.platapi.gradle.util.SpotbugsExclusionConfigProvider
...
class EntryPoint implements Plugin<Project> {
  ...
  private static void configureGroupingTasks(Project project) {
    ...
    // using all source sets and not just declared in platapiConfig to be able to run quality plugins
    ...
    configurePlugin(project,
      ...
      project.configure(project) {
        ...
        if (platapiConfig.pmdIncremental) {
          if (PmdplatapiConfig.metaClass.properties.any {
